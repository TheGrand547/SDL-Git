...
int main(int argc, char *argv[]) {
	...
	dot.setRenderingValues(gRenderer, &screenPos);
	...
	while(!contra.quit) {
		...
		boxes.drawGroup();
		small.render(gRenderer, screenPos); // TODO: Seperate the upating and the drawing of entities
		ap.update(gRenderer);
